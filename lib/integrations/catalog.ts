...
export const integrationCatalog: IntegrationProvider[] = [
  {
    ...
    webhook: true,
    readOnly: true,
    note: "OAuth 2.0; Portero requests an accounting connection and only issues read calls.",
  },
  {
    id: "xero",
    title: "Xero",
  ...
  },
  {
    ...
    env: ["META_WHATSAPP_APP_SECRET", "META_WHATSAPP_VERIFY_TOKEN"],
    webhook: true,
    readOnly: false,
  ...
  },
  {
    ...
    title: "Notion",
    category: "Knowledge",
    description: "Index only the pages and databases explicitly shared with Portero.",
    authMode: "oauth2",
    permissions: ["User-selected pages and databases"],
    env: ["NOTION_CLIENT_ID", "NOTION_CLIENT_SECRET"],
    webhook: false,
    readOnly: true,
    note: "Notion's authorization screen controls the exact workspace content Portero can access.",
  },
  {
    id: "outlook",
    title: "Outlook",
  ...
  },
  {
    ...
    credentialFields: [{ key: "apiKey", label: "Granola API key", secret: true }],
    env: [],
    webhook: false,
    readOnly: true,
