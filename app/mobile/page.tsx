...
function MobileApp() {
  ...
  const install = async () => { if (installEvent?.prompt) { await installEvent.prompt(); setInstallEvent(undefined); } else notify(copy("Install Aval", "Instalar Aval"), copy("Use Add to Home Screen in your browser menu.", "Usa Agregar a pantalla de inicio en el menú del navegador.")); };
